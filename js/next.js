...
$(document).ready(function() {
	...
	listCommands = 'Available commands: [about] [bio] [clear] [contact] [skills] [social] [projects] [quote]',
	commandNotFound = 'Command not found. Don\'t worry, it\'s probably just a glitch in the Matrix. Gli Glitch in the Matrix trix.',
	skills = "Ableton Live, Home Brew, CNC, Matlab, Zemax, Python, HTML, CAD, Linux.",
	contact = "Contact me on Twitter -> @VSeanc";
	// let
	...
	function generateContactHTML() {
		...
		let githubLink = $('<a>Github</a>').attr({
			'href': 'https://github.com/somethingtodo123/',
			'target': '_blank'
		});

		let twitterLink = $('<a>Twitter</a>').attr({
			'href': 'https://twitter.com/VSeanc',
			'target': '_blank'
		});
	...
	function generatePortfolioHTML() {
		...
		let portfolioLink = $('<a>ForgingBlock</a>').attr({
			'href': 'https://forgingblock.io/',
			'target': '_blank'
		});

		let portfolioLink2 = $('<a>Musicoin</a>').attr({
			'href': 'https://musicoin.org/',
			'target': '_blank'
		});
		let portfolioText = "You can see my projects: ";

		portfolioContainer.append(portfolioText);
		portfolioContainer.append(portfolioLink);
		portfolioContainer.append(" and ");
		portfolioContainer.append(portfolioLink2);
	...
	let shortBio = 'I started my first company since 17 years old, passion in entrepreneurship. Come up new ideas everyday that even impacting sleep quality. Like making new friends, and listen their stories ';
